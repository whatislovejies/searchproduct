    var canvas = document.getElementsByTagName('canvas')[0]
            ...
            var config = {
                ...
                DENSITY_DISSIPATION: 0.98, // Увеличьте значение для медленной диссипации
                VELOCITY_DISSIPATION: 0.99, // Увеличьте значение для медленной диссипации
                PRESSURE_DISSIPATION: 0.9, // Увеличьте значение для медленной диссипации
                PRESSURE_ITERATIONS: 10, // Увеличьте количество итераций для более плавной анимации
                CURL: 30,
                SPLAT_RADIUS: 0.003
            };
